...
class BVOEditor(QWidget):
    def __init__(self, parent=None):
        ...
        search_bar.setPlaceholderText("Hi, Tell me what BVO you want to make!")
        ...
        # Add BVO editor
        self.bvo_editor = QTextEdit()
        self.bvo_editor.setPlaceholderText("BVO Editor")
        self.bvo_editor.setStyleSheet("background-color: #323234; color: #FFFFFF; padding: 10px;")

        # Set the font for the text editor
        font = QFont("Consolas", 12)
        self.bvo_editor.setFont(font)

        content_layout.addWidget(self.bvo_editor)
    ...
    def update_mobile_view(self):
        ...
        """
        self.mobile_view.setHtml(css_code + bvo_code)

    def set_code(self, code):
        self.bvo_editor.setPlainText(code)
        self.update_mobile_view()
